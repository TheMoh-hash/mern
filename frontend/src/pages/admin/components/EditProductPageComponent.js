...
import {
  changeCategory,
  setValuesForAttrFromDbSelectForm, setAttributesTableWrapper
} from "./utils/utils";
        ...
        <Col md={6}>
          ...
          >
            ...
            <Form.Group className="mb-3" controlId="formBasicCount">
              <Form.Label>Nombres de paires En Stock</Form.Label>
              <Form.Control
                name="count"
                required
                type="number"
            ...
            <Form.Group className="mb-3" controlId="formBasicCategory">
              ...
              >
                <option value="Choose category">Choisir la catégorie</option>
            ...
            <Form.Group controlId="formFileMultiple" className="mb-3 mt-3">
              ...
              <Form.Control
                ...
                multiple
                onChange={(e) => {
                  setIsUploading("Téléchargement des fichiers en cours...");
                  if (process.env.NODE_ENV !== "production") {
                    ...
                    setIsUploading(
                      "Téléchargement du fichier terminé. Attendre que le résultat prenne effet, actualiser aussi si nécessaire"
                    );
                    setTimeout(() => {
                      setImageUploaded(!imageUploaded);
                    }, 5000);
