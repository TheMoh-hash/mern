      ...
      <Row className="mt-4">
        ...
        <Col md={8}>
          ...
          <Row>
            <Col md={6}>
              ...
              <b>Téléphone</b>: {userInfo.phoneNumber}
            </Col>
            <Col md={6}>
              <h2>Mode de paiement</h2>
              <Form.Select value={paymentMethod} disabled={true}>
                <option value="pp">PayPal</option>
                <option value="tm">T-money</option>
                <option value="fz">Flooz</option>
                <option value="cod">
        ...
        <Col md={4}>
          <ListGroup>
            ...
            <ListGroup.Item>
              Prix des articles (hors taxes):{" "}
              <span className="fw-bold">{cartSubtotal} FCFA</span>
            </ListGroup.Item>
            <ListGroup.Item>
              Expédition: <span className="fw-bold">inclus</span>
            </ListGroup.Item>
            <ListGroup.Item>
