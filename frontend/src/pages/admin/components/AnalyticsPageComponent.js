...
const AnalyticsPageComponent = ({
  ...
  return (
    <Row className="m-5">
      ...
      <Col md={10}>
        <h1>
          Chiffre d’affaires cumulé du Black Friday {firstDateToCompare} VS{" "}
          {secondDateToCompare}
        </h1>
        <Form.Group controlId="firstDateToCompare">
          <Form.Label>Sélectionnez la première date à comparer</Form.Label>
          <Form.Control
            onChange={firstDateHandler}
            type="date"
            name="firstDateToCompare"
            placeholder="Première date à comparer"
            defaultValue={firstDateToCompare}
          />
        </Form.Group>
        <br />
        <Form.Group controlId="secondDateToCompare">
          <Form.Label>Sélectionnez la seconde date à comparer</Form.Label>
          <Form.Control
            onChange={secondDateHandler}
            type="date"
            name="secondDateToCompare"
            placeholder="Seconde date à comparer"
