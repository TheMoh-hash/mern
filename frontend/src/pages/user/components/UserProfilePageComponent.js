          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control
                ...
                value={
                  user.email +
                  "  Si vous souhaitez modifier votre adresse e-mail, supprimer votre compte et  créer en un nouveau avec une adresse e-mail"
                }
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicPhone">
              ...
              <Form.Control
                type="text"
                placeholder="Saisisser votre numéro de téléphone"
            ...
            <Form.Group className="mb-3" controlId="formBasicAddress">
              ...
              <Form.Control
                type="text"
                placeholder="Entrez le nom de votre rue et votre numéro de maison"
            ...
            {/* <Form.Group className="mb-3" controlId="formBasicState">
              ...
              <Form.Control
                type="text"
                placeholder="Entrez le nom de votre Etat"
